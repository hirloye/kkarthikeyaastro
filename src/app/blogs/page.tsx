    ...
    <main className="relative min-h-screen w-full text-slate-100 overflow-x-hidden flex flex-col selection:bg-amber-500/30">
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto px-6 pt-6 pb-12 md:pt-8 md:pb-20 relative z-10">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 border border-white/5 rounded-3xl bg-slate-900/30 backdrop-blur-md shadow-inner">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog, idx) => (
              <motion.article
                ...
                className="group flex flex-col bg-slate-900/30 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden shadow-inner hover:bg-slate-900/50 hover:border-amber-500/30 transition-all duration-300"
              >
                <Link href={`/blogs/${blog.slug}`} className="block relative h-56 overflow-hidden bg-white p-2">
                  <img
